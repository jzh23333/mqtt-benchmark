...
func (pa *PubackPacket) String() string {
	return fmt.Sprintf("%s MessageID: %d payload: %v", pa.FixedHeader, pa.MessageID, pa.Payload)
}
...
func (pa *PubackPacket) Unpack(b io.Reader) error {
	...
	pa.Payload = make([]byte, pa.FixedHeader.RemainingLength)
	_, err = b.Read(pa.Payload)
